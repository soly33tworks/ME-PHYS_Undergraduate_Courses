...
################### OPEN FIG FILE ######################
directory = r'Sample Results/4Vpp35S/Filtered_Plot.fig.pickle' # Write the directory here (sometimes it can't read the directory, move the folder in the same folder as the code and try again)
